                                ...
                                <div class="col-md-4 col-xl-4">
                                        <div class="card bg-c-blue order-card">
                                            <div class="card-block">
                                                ...
                                                @endphp
                                                <h2 class="text-right"><i class="fas fa-balance-scale-right f-left"></i><span>{{$cant_procesos}}</span></h2>
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <div class="card bg-c-pink order-card">
                                            <div class="card-block">
                                                ...
                                                @endphp
                                                <h2 class="text-right"><i class="fas fa-calendar-check f-left"></i><span>{{$cant_blogs}}</span></h2>
                                    ...
                                    <div class="col-md-4 col-xl-4">
                                        <div class="card bg-warning order-card">
                                            <div class="card-block">
                                                ...
                                                @endphp
                                                <h2 class="text-right"><i class="fas fa-calendar-check f-left"></i><span>{{$cant_clientes}}</span></h2>
